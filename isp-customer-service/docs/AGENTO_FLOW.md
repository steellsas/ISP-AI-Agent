...
išgirsta dalis („…—"). `asked` NEatsukamas (2026-08-07 review): **kitas turn'as
nusprendžia** — ankstyvas atsakymas („taip, dega raudona!") užsiskaito ir judama
toliau; klausimas eina per side_topic su inkaru; nesuprantama — hold ir
natūralus perklausimas. Pertraukianti frazė tampa naujo atsakymo pradžia —
žodžiai nedingsta.
...
6. ~~Scripted turn'ų kliento frazės nepatenka į LLM istoriją~~ — **pataisyta
   2026-08-07** (review fix: vienas append priekyje, istorija be skylių; kartu
   pataisyta: reopen valo įrodymų žurnalą, barge-in nebeperklausia atsakyto).
