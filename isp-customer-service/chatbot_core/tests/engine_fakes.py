...
_FLOW_OF = {
    ...
    "_ingest_client_evidence": "agent.perception_flow.ingest_client_evidence",
    ...
    "_on_task_question": "agent.perception_flow.on_task_question",
    ...
    "_prefill_slots_from_text": "agent.identification_flow.prefill_slots_from_text",
    ...
    "anchor_text": "agent.perception_flow.anchor_text",
    "classify_side_topic": "agent.perception_flow.classify_side_topic",
