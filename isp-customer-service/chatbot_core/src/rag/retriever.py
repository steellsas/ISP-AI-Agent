...
class Retriever:
    ...
    def add_documents(
        ...
        try:
            ...
            self.vector_store.add(
                embeddings=embeddings, documents=documents, metadata=metadata, ids=ids
            )
    ...
    def load_documents_from_directory(
        self, directory: str | Path, file_extension: str = ".md", recursive: bool = True
    ):
        """
...
if __name__ == "__main__":
    ...
    # Test retrieval
    print("\nTesting retrieval...")
    queries = ["Internetas neveikia", "TV problema", "Lėtas ryšys"]
