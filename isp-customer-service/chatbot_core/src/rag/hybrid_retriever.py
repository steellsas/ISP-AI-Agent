...
class HybridRetriever:
    ...
    def __init__(self, retriever, keyword_weight: float = 0.3, rrf_k: int = _RRF_K):
        ...
        # Stop words dropped during tokenization (the knowledge base language's
        # glue words, from the locale vocabulary): BM25 keeps meaningful terms.
        from agent.contract.locale import vocab_set

        self.stop_words = set(vocab_set("rag_stop_words"))
