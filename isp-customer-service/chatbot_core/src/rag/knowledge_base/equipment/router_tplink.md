...
kind: equipment
equipment: [tplink]
tags: [lights, buttons, ports, reset, wifi, model]
keywords: [router, tplink, archer, lemputes, lemputė, indikatoriai, mygtukai, reset, wps, nustatymai,
  admin, wifi, slaptazodis, 192.168.0.1]
---
