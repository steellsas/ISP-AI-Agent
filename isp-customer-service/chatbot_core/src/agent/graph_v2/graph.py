...
Current shape: perceive -> router -> identification | ticket | closing |
DIAGNOSIS SUBGRAPH (diagnose -> side_topic | solver_gate -> walker ->
executor -> narrator) -> END, checkpointed per session.
"""
...
def build_graph(checkpointer: Any | None = None):
    ...
    builder.add_conditional_edges(PERCEIVE, route_entry, {name: name for name in ENTRY_TARGETS})
