"""Keyword and regex readers of one caller utterance — pure functions over the
locale vocabulary (yes/no, restored, farewell, ticket consent, turn intent, …).
They read; the rules that act on a reading live in decide."""
