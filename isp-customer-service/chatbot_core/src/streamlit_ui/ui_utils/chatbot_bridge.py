...
try:
    from services.llm.client import register_stats_callback
    from services.llm.stats import reset_session_stats
...
def is_conversation_ended(result: dict) -> tuple[bool, str | None]:
    """
